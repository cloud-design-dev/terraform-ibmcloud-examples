# Classic Windows virtual server using cloud-init
This example will deploy a Windows 2019 server. The [cloud-init](https://cloudinit.readthedocs.io/en/latest/) script will then download the IBM Cloud CLI as well as enable the [WSL](https://docs.microsoft.com/en-us/windows/wsl/about) feature. 
...
$ cd ClassicVSI-WindowsCloudInit
```
