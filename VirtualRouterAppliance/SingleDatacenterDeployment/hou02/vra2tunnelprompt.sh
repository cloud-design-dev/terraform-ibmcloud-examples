...
sed -i "s|PUBLIC_PEER_IP|$VRA_PUBLIC_PEER|g" /tmp/createVra2Tunnel.vcli
sed -i "s|PRIVATE_PEER_IP|$VRA_PRIVATE_PEER|g" /tmp/createVra2Tunnel.vcli
sed -i "s|LOCAL_PUBLIC_PEER_IP|$VRA_PUBLIC_LOCAL_PEER|g" /tmp/createVra2Tunnel.vcli 
sed -i "s|LOCAL_PRIVATE_PEER_IP|$VRA_PRIVATE_LOCAL_PEER|g" /tmp/createVra2Tunnel.vcli 
sed -i "s|PASSWORD|$VRA_SECRET|g" /tmp/createVra2Tunnel.vcli 

/bin/vcli /tmp/createVra2Tunnel.vcli